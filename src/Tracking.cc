...
cv::Mat Tracking::GrabImageRGBD(const cv::Mat &imRGB,const cv::Mat &imD, const double &timestamp,const sensor_msgs::LaserScanConstPtr& scan)
{
    mImGray = imRGB;
    cv::Mat imDepth = imD;
    ...
    mCurrentFrame = Frame(mImGray,imDepth,timestamp,mpORBextractorLeft,mpORBVocabulary,mK,mDistCoef,mbf,mThDepth,scan);
...
bool Tracking::Relocalization()
{
    ...
    {
       std::cout<<"relocalisation: have no candidate keyframes!!"<<std::endl;
       return false;
    }
