...
public:
    ...
    cv::Mat TrackRGBD(const cv::Mat &im, const cv::Mat &depthmap, const double &timestamp,const sensor_msgs::LaserScanConstPtr &scan);
    ...
    sensor_msgs::LaserScan GetLastKeyframeScan();
    // generate the 2d Map
    // Save 2d map
    void PublishMap();
...
private:
    ...
    //mapping 2d --@rongbohou
    Mapping2d* mMapping2d;
