...
size_t SparseImgAlign::run(FramePtr ref_frame, FramePtr cur_frame, Sophus::SE3& T_cur_ref)
{
  reset();
    ...
    bool compute_weight_scale)
{
  ...
  //cout<<" in RGBD_DSLAM chi2/n_meas_"<<chi2/n_meas_<<endl;
  return chi2/n_meas_;//光度误差平方和的均值
}
